...
索引运算符和属性选择我们已经讲过了，因为它们的工作方式与 Python 生态系统的其余部分一样。作为新手，这使它们易于上手和使用。但是，pandas 有自己的访问器运算符 loc 和 iloc。对于更高级的作，这些是您应该学习使用的。
...
>>>>>>> c4950a5c7521fef472a665cda5d7ffb85dd9f496
